...
if (!class_exists('PR_DHL_WC_Order')) :
	 ...
	 */
		...
		protected function get_label_args($order_id)
		{
			...
			// If not USA, Canada, or Australia, then change state from ISO code to name
			if ($shipping_address['country'] != 'US' && $shipping_address['country'] != 'CA' && $shipping_address['country'] != 'AU') {
