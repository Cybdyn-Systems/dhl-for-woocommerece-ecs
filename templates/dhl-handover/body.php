			...
			<div class="row row-2">
				...
				<div>
					<div class="handover-option">
						<div
							class="circle <?php echo $shipping_dhl_settings['dhl_handover_type'] == 'dropoff' ? 'active' : ''; ?>"></div> <?php echo __("Drop-Off"); ?>
					</div>
					<div class="handover-option">
						<div
							class="circle <?php echo $shipping_dhl_settings['dhl_handover_type'] == 'pickup' ? 'active' : ''; ?>"></div> <?php echo __("Pick-Up"); ?>
					</div>
				</div>
				<div class="dist-item">
